...
location.name = "212 Loden Lane, Henrietta, NY";
...
password = "weasel270266";
var provider = process.env.PGO_PROVIDER || 'google';
provider = "ptc";

var username1 = process.env.PGO_USERNAME || 'nmr9601@g.rit.edu';
var password1 = process.env.PGO_PASSWORD || 'Weasel2702662';
